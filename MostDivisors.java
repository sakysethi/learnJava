...
//This program finds the integer between 1 and 10000 that has  the largest number of divisors.  
//It prints out the maximum number of divisors and an integer that has that many divisors.
